...
const teamMembers: TeamMember[] = [
  ...
  { nick: 'maleon17', role: 'Админ / Разработчик', desc: 'Создал главного бота, бота поддержки и мод на верификацию, а также участвует в разработке сайта. Отвечает за ботов, авторизацию и сайт.', groups: ['core'] },
  { nick: 'bibidistra', role: 'Разработчик', desc: 'Участвовал в разработке сайта проекта, строительстве, делал и расставлял NPC по карте.', groups: ['core', 'tlb'] },
    ...
    <>
      ...
      <section className="about" id="about">
        <div className="container">
          ...
          <p>Первый проект — <strong>The Lost Beyond: Reboot</strong>: постапокалипсис, две враждующие фракции, зомби и война за выживание. Сейчас сервер <strong style={{ color: '#f39c12' }}>временно на паузе</strong>, но проект не заброшен — следите за новостями.</p>
      ...
      <Footer
        ...
        navLinks={[
          ...
          { label: 'О платформе', href: '/#about', external: true },
        ]}
      />
    </>
  );
